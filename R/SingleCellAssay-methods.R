...
##' Accessor for cellKey
##'
##' This returns the cellKey, which is a unique identifier generated by \code{idvars} in the \code{mapping}
##' @title getcellKey
##' @param sc An object with a \code{cellKey}
##' @return \code{integer} giving the unique id generated
##' @name getcellKey-method
##' 
##' @exportMethod getcellKey
##' @docType methods
##' @rdname getcellKey-methods
##' @keywords accessor
setGeneric('getcellKey', function(sc) standardGeneric('getcellKey'))
...
##' @rdname getcellKey-methods
##' @aliases getcellKey,SingleCellAssay-method
setMethod('getcellKey', 'SingleCellAssay', function(sc) sc@cellKey)
...
##' @keywords accessors
setMethod('nrow', 'SingleCellAssay', function(x) length(getcellKey(x)))
...
### index by numeric index or boolean.
  selectedKeys <- getcellKey(x)[i]
  meltKeys <- melt(x)[,"__cellKey"] %in% selectedKeys
  env <- new.env()

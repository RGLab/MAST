...
eid <- AnnotationDbi::select(TxDb.Hsapiens.UCSC.hg19.knownGene,keys = mcols(sca)$entrez,keytype ="GENEID",columns = c("GENEID","TXNAME"))
...
ggplot(predicted_sig)+aes(x=arm::invlogit(etaD),y=muC,xse=seD,yse=seC,col=sample)+

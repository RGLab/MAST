...
## lrout2 <- zlm.SingleCellAssay(et ~ Subject.ID, fd.spl[[1]], hypothesis.matrix='Subject.IDSub02')
## This isn't true while we use Wald tests in zlm
## context('testing for equality between glm lrtest and two-sample')
## expect_equal(lrout$lrstat, lrout2[,2,3])
